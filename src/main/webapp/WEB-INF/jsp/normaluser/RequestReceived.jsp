...
<div class="container">
	...
	<form action="/requestsearch" method="get">

		Search <input type="number" name="search" class="form-control" >
		<br>
		<input type="submit"
	...
	<table border="1" cellpadding="3">
		...
		<c:forEach items="${requestPayments}" var="requestPayments">
			<tr>
				...
				<td><a href="/fullfillrequest?id=${requestPayments.id }&userid=${requestPayments.fromUserId }">Fulfill Request</a> </td>
			</tr>
		</c:forEach>
	</table>
	</c:otherwise>
